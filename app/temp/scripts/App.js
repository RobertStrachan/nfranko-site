...
var _ModalDescription = __webpack_require__(3);
...
var modalDescription = new _ModalDescription2.default();
...
var ModalDescription = function () {
    function ModalDescription() {
        _classCallCheck(this, ModalDescription);

        this.closeModalButton = (0, _jquery2.default)('.book__modal--close');
        this.openModalButton = (0, _jquery2.default)('.book__modal--open');
        this.modal = (0, _jquery2.default)('.book__description');
        this.events();
    }

    _createClass(ModalDescription, [{
        key: 'events',
        value: function events() {
            ...
            this.modal.each(function (i) {
                ...
                that.openModalButton[i].addEventListener('click', function () {
                    (0, _jquery2.default)(currentBook).addClass("book__description--is-visible");
                });
                that.closeModalButton[i].addEventListener('click', function () {
                    (0, _jquery2.default)(currentBook).removeClass("book__description--is-visible");
                });
            });
        }
    }]);
